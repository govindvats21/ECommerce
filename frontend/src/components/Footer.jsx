    ...
    <footer className="w-full bg-[#131921] text-white pt-0 pb-6 mt-10">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-20 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Premium Ecommerce Experience. Electronics se lekar daily essentials
            tak, VatsStore deta hai aapko bharosa aur sabse tez delivery.
          </p>
        </div>

        {/* 🔗 Column 2: User Links */}
        <div>
          <h3 className="font-bold mb-4 text-white border-b border-gray-700 pb-2 inline-block">
            VatsStore Shopping
          </h3>
          <ul className="text-gray-400 text-sm space-y-2">
            <li>
              <Link to="/orders" className="hover:text-[#ff4d2d] transition">
                My Orders
              </Link>
            </li>
            <li>
              <Link to="/cart" className="hover:text-[#ff4d2d] transition">
                Cart Items
              </Link>
            </li>
            <li>
              <Link to="/profile" className="hover:text-[#ff4d2d] transition">
                Account Settings
              </Link>
            </li>
        ...
        <div>
          ...
          <div className="flex gap-4 mb-6">
            <a
              href="https://www.instagram.com/govindvats2803"
              target="_blank"
            ...
            <a
              href="mailto:govindvats11m@gmail.com"
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-20 mt-12 pt-6 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4 text-[11px] text-gray-500">
        ...
        <p className="text-center md:text-right">
          &copy; 2026, VatsStore Ecommerce. <br className="md:hidden" /> Crafted
          with 🔥 by Govind Vats
        </p>
      </div>
    </footer>
