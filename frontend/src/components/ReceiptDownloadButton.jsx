...
export default function ReceiptPage({ order }) {
  ...
  const shippingFee = order?.totalAmount > 500 ? 0 : 40; // If order > 500, free delivery; otherwise ₹40 shipping fee
  const amountWithShippingFee = order?.totalAmount + shippingFee;
        ...
        >
          ...
          >
            ...
            <div className="text-right">
              <h2 style={{ color: "#111827" }} className="text-xl font-semibold">
                INVOICE
              </h2>
          ...
          <div className="mb-6 grid grid-cols-2 gap-6">
            {/* Billing To */}
            <div>
              <h3 style={{ color: "#111827" }} className="font-semibold mb-2">
                Billing To:
              </h3>
          ...
          <div className="flex justify-between mb-6">
            ...
            <div className="w-1/3">
              ...
              <div className="flex justify-between py-1">
                <span>Shipping</span>
                <span>{shippingFee === 0 ? 'Free' : '₹40'}</span>
              </div>
              <div className="flex justify-between py-1 font-semibold">
                <span>Total</span>
                <span>₹{amountWithShippingFee}</span>
              </div>
            </div>
          </div>
